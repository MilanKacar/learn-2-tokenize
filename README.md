...
Tokenization is the process of breaking down text into smaller units called **tokens** that language models can process. This playground demonstrates **Byte Pair Encoding (BPE)**, the algorithm used by GPT-style models:
...
```bash
git clone https://github.com/MilanKacar/learn-2-tokenize.git
cd learn-2-tokenize
```
...
* Uses an educational BPE implementation to demonstrate the algorithm clearly

---

## 🔗 Related Resources

* OpenAI's GPT Tokenizer: [https://platform.openai.com/tokenizer](https://platform.openai.com/tokenizer)
* Hugging Face Tokenizers: [https://huggingface.co/docs/tokenizers/](https://huggingface.co/docs/tokenizers/)
* Byte Pair Encoding Paper: [https://arxiv.org/abs/1508.07909](https://arxiv.org/abs/1508.07909)
